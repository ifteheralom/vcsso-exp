...
//import org.example.sign.Ed25519Signature2020;
//import org.example.sign.Proof;
//import org.example.utils.Mnemonic;
...
//
//        // Verify the JWT
//        JWTVerifier.verifyJWT(vcJwt, Algorithm.ECDSA256((ECPublicKey) keyPair2.getPublic(), null));
