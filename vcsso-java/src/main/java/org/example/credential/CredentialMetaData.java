...
public class CredentialMetaData {
    ...
    private CredentialMetaData(List<URI> contexts, URI id, List<URI> types, URI issuer, Instant issuanceDate,
                               Instant expirationDate, Status status, Map<String, Object> otherProperties) {
    ...
    public static class Builder {
        ...
        private URI id;
        private List<URI> additionalTypes = new ArrayList<>();
        private URI issuer;
        ...
        public Builder additionalTypes(List<URI> types) {
            this.additionalTypes = types;
            return this;
        }

        public Builder additionalType(URI type) {
            additionalTypes.add(type);
            return this;
        }

        public Builder additionalType(String type) {
            additionalTypes.add(URI.create(type));
            return this;
        }
        ...
        public CredentialMetaData build() {
            if (id == null || additionalTypes == null || issuer == null || issuanceDate == null)
            ...
            additionalTypes.add(0, URI.create("VerifiableCredential"));
            return new CredentialMetaData(additionalContexts, id, additionalTypes, issuer, issuanceDate,
